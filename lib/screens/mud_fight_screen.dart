              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: FightAnimation(
                    ...
                    enemyHealth: combatResult?.remainingEnemyHealth ??
                        (combatData.enemyHealth * combatData.enemyCount)
                            .toInt(),
                    playerMaxHealth:
                        gameProvider.gameState.maxHealth.toDouble(),
                    enemyMaxHealth:
                        combatData.enemyHealth * combatData.enemyCount,
                    ...
                    currentWeapon:
                        gameProvider.combatResult?.fightLog.isNotEmpty == true
                            ...
                            : 'fists',
                    showBloodEffects: (gameProvider.gameState.health <
                    ...
                    child: Column(
                      children: [
                        ...
                        LinearProgressIndicator(
                          value: gameProvider.gameState.health /
